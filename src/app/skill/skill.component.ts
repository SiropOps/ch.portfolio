...
export class SkillComponent implements AfterViewInit, OnInit {
    ...
    private dataAcademyType = [
        ...
        [{
            ...
            "categoryLabel": "Débutant",
            "axisLabel": "Apprendre à apprendre : Concevoir son projet d’apprentissages et le piloter. Faire des choix favorisant ses apprentissages et le développement de ses compétences vers un niveau professionnel",
            "why": "<p>L’article réflexif m’a plongé dans 3 documents riches en informations et en théorie. Ce travail m’a obligé à sélectionner, ordonner et synthétiser les notions les plus pertinentes pour exposer clairement ma réflexion. Pour y parvenir, j’ai compris l’importance de travailler et comprendre un texte pour s’approprier la pensée de l’auteur.e et être capable de la résumer le plus fidèlement. À travers les diverses citations de ces lectures scientifiques et des autres réalisées durant ce 2e semestre, j’entrevois la profusion des recherches et des théories produites par l’humanité. C’est à la fois stimulant de voir toutes ces notions potentiellement assimilables et frustrant de réaliser la carence en temps pour le faire. Il est cependant rassurant de réaliser que toute la matière théorique existe et qu’il ne reste plus qu’à faire des choix pour développer au mieux ses compétences. </p><p>Sélectionner et lire des articles pour orienter son apprentissage est une chose, mais s’en rappeler en est une autre ! J’ai remarqué que faire des liens avec d’autres théories, ma pratique professionnelle et ma vie privée me permet de mieux intégrer les concepts. Cependant, j’ai constaté que les notions que j’ai le plus assimilées sont celles sur lesquelles j’ai le plus discuté avant de les passer par écrit. </p><p>Par ces expériences du 2e semestre (lecture et résumé, liens entre les articles lus et les notions amenées dans les cours, les labos et les liens avec ma vie privée), je commence dorénavant à mieux comprendre ce qui me permet de mieux assimiler des concepts. Néanmoins, je dois encore trouver un moyen efficace et rapide de noter les divers rapprochements que j’effectue mentalement pour réussir à les utiliser. </p><p>L’évènement le plus marquant et la décision qu'il me faudra prendre concernant l'orientation que je souhaite donner à mon projet de formation. Je sors d’un entretien pour une place en cours d’emploi d’éducateur. Il me faut décider qu’est-ce qui favorisera le mieux mon apprentissage en fonction de mon projet de vie. Est-ce de continuer à me former à plein temps dans le mode Team Academy ou basculer dans une formation en cours d’emploi dans la filière classique ? Cité Printemps est-elle préférable pour effectuer mes apprentissages, plutôt que cette nouvelle institution ? Rien n’est encore joué, mais je dois me préparer à cette question dans le cas où l’institution me donne une réponse positive. </p>",
        },
        {
            "category": "C10",
            "power": 2,
            "categoryLabel": "Débutant",
            "axisLabel": "Apprentissage en équipe : Se former ensemble avec d'autres membres de l'équipe et créer de nouvelles connaissances par la mutualisation des savoirs et la stimulation réciproque",
            "why": "<p>Avec mes groupes de projets puis en lisant des articles scientifiques et en écoutant les présentations des AR, j'ai appris que pour construire une relation professionnelle épanouissante, il fallait trouver le juste équilibre entre les dimensions socioaffectives et la centration sur la tâche. Je commence à développer les aptitudes de bases pour créer un climat propice à l’échange et la collaboration grâce aux apports des cours F7 sur les relations interpersonnelles et du F6 sur la communication et les explications de la psychologie sociale sur les groupes et leurs dynamiques, ainsi que sur les notions de comparaison sociales. Je développe également ces attitudes en les expérimentant et les travaillant dans mes groupes de travail, mes relations professionnelles et privées. </p><p>La bonne ambiance dans mes groupes de travail et de révisions nous a permis des débats sincères et ouverts, suivis d'explications, qui nous ont permis de faire évoluer nos visions sur certains sujets, et d’assimiler plus facilement certaines matières. </p><p>J’ai pu développer cette compétence dans le projet multimédia du F6. Les divergences et discussions quant aux phénomènes d’influence minoritaire et majoritaire ainsi que sur les processus de complaisance, d’identification et d’intériorisation, nous a permis de mieux intégrer ces notions. </p><p>Les examens plus originaux du F8 (droit aux documents) et du F7 (présentation vidéo avec les questions connues à l’avance) représentent finalement une grosse charge de travail. Mon temps s’amenuise très vite, alors pour résoudre ce problème nous allons nous partager les résumés, les questions et nous les présenter. J’ai l’espoir que cette mutualisation des travaux et des connaissances nous stimulera suffisamment pour intégrer toute la matière nécessaire ! </p>",
        },
        {
            "category": "C11",
            "power": 3,
            "categoryLabel": "Apprenant",
            "axisLabel": "Auto-initiative : démontrer une volonté affirmée de lancer des projets en s’appuyant sur ses compétences et un état d’esprit entrepreneurial",
            "why": "<p>Je lie l’auto-initiative à l’autodétermination et les différents types de motivation qu'elle sous-tend. J’ai pu aborder ces notions dans l’article d’Arnaud ainsi que les cours sur le DPA PC. Je sens que mes appuis théoriques sont encore rudimentaires. Cependant, ils m’ont déjà permis d’amorcer un bout d’analyse quant au processus en action lorsque je me mobilise. </p><p>J’ai pu m’appuyer sur mon sentiment de donner une bonne image (motivation extrinsèque internalisée) de l’équipe STA pour répondre à la proposition de l’ASLEC concernant son projet d’animation. J’ai employé mes compétences rédactionnelles et relationnelles pour entrer en contact avec eux et fixer un entretien. J’ai été honnête avec mon intérêt pour ce projet, mon manque de temps et ma volonté d’arriver à une solution pour y participer. J’ai réussi à motiver 3 autres sociopreneuses.eurs, tout en négociant avec mon autre groupe du projet HP pour réduire mon implication ou sortir de celui-ci. Je peux maintenant contacter l’éducatrice responsable de l'ASLEC pour lui annoncer notre future collaboration. </p><p>Suite à cette proposition et la réponse que j’avais imaginé collective, j’ai émis plusieurs fois l’idée d’organiser un système de communication efficace dans notre équipe STA. Dans cette lancée, deux sociopreneuses.eurs ont décidé de proposer une SD en lien avec ce thème. J’ai décidé de me joindre à eux pour les soutenir et apporter mes idées dans sa réalisation. </p><p>Dans le travail à rendre pour le module F10, j’ai pris l’initiative de proposer une autre thématique que celle initialement prévue. Je constatais que nous n’arrivions pas à la préciser suffisamment et nous mettre d’accord. J’ai donc réussi à convaincre le groupe d’opter pour une problématique en lien avec l’escalade, en me basant sur mes connaissances et mes compétences dans cette discipline ainsi que sur mon réseau. </p><p>Même si l’on peut discuter sur la notion de projet ou non, j’ai de plus en plus le sentiment de prendre des initiatives dans mes différents groupes de travail ou dans ma carrière d’étudiant. Je ressens également que mes interventions sont plus réfléchies, étayées et appuyées par mes compétences que simplement déclenchées par une pulsion émotionnelle. </p>",
        },
        {
            "category": "C12",
            "power": 3,
            "categoryLabel": "Apprenant",
            "axisLabel": "Leadership d’équipe : construire une équipe qui fonctionne sur une longue période et à conduire cette équipe",
            "why": "<p>En me référant à l’article d’Arnaud (2008), j’ai acté qu’il fallait se soucier du niveau des besoins : d’autonomie, de compétences et de reconnaissances de tous les membres d’un groupe, pour contribuer à un bon leadeurship d’équipe. J’ai pu constater et établir des liens entre les différentes théories : sur l’Humanisme et l’autodétermination expliquée dans cet article ; celle du F7 sur le DPA-PC et la participation collective ; et les présentations d’AR de mes collègues sur la dynamique de groupe, le leadeurship, l’intelligence émotionnelle, les rôles et positionnement dans les groupes. </p><p>J’ai essayé d’expérimenter plus particulièrement ces notions avec deux groupes de mes cours d’escalade. Je leur ai laissé sept minutes pour décider à l’unanimité des activités qu’ils voulaient réaliser durant le cours, avec comme consigne : chacun.e devait avoir l'envie de participer aux exercices. J’ai cependant gardé un cadre et laissé planer la « menace » de décider moi de l'animation si au bout du temps donné ils et elles n’avaient pas trouvé de consensus. J’ai constaté que la collaboration fonctionne mieux que quand je suis le seul à conduire l’équipe (selon la complexité de la tâche à effectuer). Même consigne avec le deuxième groupe (un peu plus âgée 10-13 ans). Ils ont voulu rejouer au jeu de l’oie que je leur avais déjà proposé, mais cette fois nous l’avons complètement coconstruit. J’ai pu donner cette consigne et ce type-là d’autonomie, car le groupe connaissait et avait déjà pratiqué ces exercices. Je n’aurais pas procédé de la même manière en début d’année pour éviter qu’ils se retrouvent perdus, le risque étant que la dynamique ne s'engage pas sur un début positif. À l’avenir, dans mes futurs nouveaux groupes, je travaillerai sur leurs envies d’apprentissage, et je tenterai de faire qu’ils en ressortent leurs points communs. Cela pour qu’ils développent et travaillent tout ensemble dans le sens de leur but en commun . Pour faciliter cela, je développerai plus la dynamique socioaffective du groupe par plus de jeux dans les premières séances. Cela fonctionne pareil avec les adultes. </p><p>J’essaie aussi d’adapter cette attitude dans mes groupes de travail à la différence que mes relations avec les autres personnes sont plus symétriques que dans le cadre des cours de grimpe que je donne. Cela demande une grande capacité d’empathie, d’analyse et de remise en question pour comprendre comment chacun peut contribuer, à son niveau, à aider le groupe à entreprendre et réaliser ses projets. La théorie nous dit que cela augmente l’intérêt et l’implication des personnes dans les activités et ainsi répond à la satisfaction du besoin de participer et d’être reconnu. Jusqu’à maintenant, j’ai majoritairement eux des bonnes ententes et ambiances dans mes équipes. Il en est chaque fois ressorti (parfois plus difficilement que d'autres) des travaux satisfaisants. </p><p>Je pense avoir acquis plus de connaissances théoriques de base que durant le premier semestre. J’ai mobilisé ces théories dans plusieurs situations avec des résultats satisfaisants. Cependant, pour atteindre le prochain niveau, je sens le besoin d’approfondir des techniques de communication pour mieux comprendre et évaluer les besoins des gens en face de moi et élargir mes expériences pour réussir à concevoir les pistes d’actions correspondantes. </p>",
        },
        {
            "category": "C13",
            "power": 2,
            "categoryLabel": "Débutant",
            "axisLabel": "Créativité et innovation : Générer des idées originales permettant de résoudre des problèmes. Concevoir et gérer le processus qui va de l’idée à l’innovation",
            "why": "<p>Une partie des socioentrepreneureuses (moi y compris) ont ressenti un manque et un besoin d’organisation au sein de la Team.  Trois d’entre eux que j’ai rejoints par la suite ont pris l’initiative « originale » de réaliser une SD sur cette problématique. Jean Charles nous a soufflé l’idée d’organiser un Word Café afin de mettre tout le monde au travail sur quatre thèmes que nous avons pensé primordiaux. Nous n’avons pas été très créatifs dans l’activité proposée pour résoudre ce problème, car nous avons repris une suggestion. Cependant, je n’avais encore jamais travaillé de la sorte. Ce concept permettant de mettre à profit l’intelligence collective est pour moi très novateur. J’ai également pu exercer ce principe lors de la mise en commun et la sélection des statuts de notre association. </p><p>La réalisation de la vidéo du F10 a aussi été pour moi une opportunité originale de démontrer des notions théoriques à travers l’image. Pour réaliser ce défi, nous avons opté pour créer une vraie activité d’escalade avec deux à quatre jeunes de Saint-Raphaël. Les études que j’ai lues sur l’escalade et la littérature sur l’estime de soi a fait écho à beaucoup d'action que je mets en place dans l'enseignement de ce sport pour faire évoluer les gens. Cela m’a permis de préparer trois séances spécifiques d'escalade en sélectionnant les bons exercices et en les variant légèrement  dans le but de produire les images dont nous avions besoin pour la vidéo. </p><p>Le défi du Houston Call, a été une occasion pour créer un concept de présentation originale de notre classe de A à Z. cela a été possible, car toute l’équipe c’est senti responsable de ce projet. Chacun a pu y prendre part en apportant sa contribution, ce qui a rendu le résultat final plutôt fluide. </p>",
        },
        {
            "category": "C14",
            "power": 2,
            "categoryLabel": "Débutant",
            "axisLabel": "Agir entrepreneurial : démontrer une attitude volontaire dans laquelle les croyances et les barrières limitant la réflexion et l'action sont dépassées dans la mise en œuvre de projets à forts impacts positifs et durables.",
            "why": "<p>Fabien nous a transmis la proposition de l’ASLEC de collaborer dans leur projet d’animation des quartiers Ouest. Il nous a également plus ou moins demandé de lui rendre réponse dans un délai de trois à quatre jours. Espérer une réponse unanime de 23 personnes n’est pas envisageable, d’autant plus que cette période du semestre était relativement chargée pour tous. Face à la limite que présentait la non-réponse de la classe, j’ai réfléchi et ébauché une idée d’un système de communication différent que celui actuel : un groupe WhatsApp unique pour 23 personnes. J’ai pris une timide attitude volontaire en exposant mon idée à quelques sous-groupes identifiés de la STA. J’ai réalisé que le modèle de communication qui me paraissait simple et évident ne l’était pour quasi personne. J’en ai pris note et laissé le temps agir. </p><p>Puis lors de l’organisation de la SD Word Café, j’ai proposé (et un peu insister) sur le besoin et l’importance d’avoir des informations qui circulent facilement dans le groupe. La communication a été retenue comme un des quatre thèmes sur lesquels la STA a dû réfléchir. </p><p>Lors de la SD, j’ai pris le parti de ne pas influencer la Team en n'inscrivant pas mon « projet » sur la nappe, pour profiter pleinement de l’intelligence collective de l’équipe. Après réflexion sur le fait que je suis un membre à part entière de la Team, et un relatif désarroi de ne voir que peu de propositions concrètes sur ce thème, je n’ai pas pu m’empêcher lors du 2e round du Word Café de gribouiller un rapide et incertain schéma sur une des feuilles allant servir à récolter les avis des 22 autres socioentrepreneureuses. En raison de mon manque de stratégie et d’organisation, cette idée n’a toujours pas fait surface dans l’équipe. </p><p>Sans me résigner face à la non-entrée en matière de mes collègues quant à mon système, j’ai à nouveau marqué un temps de pause jusqu’à la prochaine occasion de réexpliquer mon concept, si dans l’intervalle, aucun autre n’a été adopté et porté ses fruits. </p><p>Finalement, lors de notre première mise en groupe pour préparer les statuts de l’association, ce système émerge timidement. Il s’esquisse l’idée de créer de petits pôles de compétences avec, pour chacun, une personne en guise de porte-parole. Les porte-paroles ont aussi un groupe dans lequel ils/elles échangent les idées de leur groupe respectif et les tiennent informés en retour. Ce concept ressemble furieusement à celui que j’avais imaginé, mis à part la constitution des groupes que j’avais prévus en fonction de finalités différentes. </p><p>Difficile de relier la résurgence de cette idée avec un « agir entrepreneurial » de ma part. Quoiqu’il en soit, les doutes et les résistances n’ont pas limité mes croyances et mes réflexions quant à mon besoin de trouver un système de communication adéquat et fonctionnel pour tous. Regarder cette situation à travers le filtre du constructivisme m’a permis de mieux accepter la non-entrée en matière de mes collègues quant à mes propositions. En effet, je comprends que ma priorité du moment (le besoin de rendre une réponse groupée) et ma solution pour le faire ne pouvaient pas faire résonance chez tout le monde pareillement en raison de la réalité ressentie et interprétée différemment par chacun d’entre nous. </p><p>Pour le travail du F10, j’ai su démontrer : mes compétences dans le domaine de l’escalade, mon réseau pour organiser des séances avec des jeunes de Saint-Raphaël et aussi obtenir un entretien avec un éducateur de l’ORIF, qui pratique l’escalade avec des jeunes. Je n’ai pas perdu mon attitude volontaire face aux mises en garde de Chantal quant au fait de contacter une institution pour notre projet. J’avais suffisamment confiance dans ma personne-ressource pour mener à bien ces séances d’escalade en coopération avec cette institution. </p>",
        }]
    ];
    ...
    caiClick(semester:string): void {
        this.router.navigate(["cai", semester]);
    };
    ...
    changeRadio(): void {
        ...
        if (this.radioModel === '1') {
            ...
            this.skillAcademyTypeChart.data = this.dataAcademyType[0];
        }
        if (this.radioModel === '2') {
            this.skillTypeChart.data = this.dataType[1];
            this.skillAcademyTypeChart.data = this.dataAcademyType[1];
        }
    }
