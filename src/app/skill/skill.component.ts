    ...
    this.browserOnly(() => {
        ...
        this.skillTypeChart.data = [
          {
            ...
            "axisLabel": "Expliciter, étayer et argumenter les valeurs, les principes éthiques et <br/> le cadre déontologique du travail social qui fondent leur action.",
          ...
          },
          {
            ...
            "axisLabel": "Évaluer leurs propres ressources et leurs limites <br/>dans les dimensions cognitives, émotionnelles, corporelles et sociales, <br/>et identifier leurs besoins en matière de professionnalisation.",
          ...
          },
          {
            ...
            "power": 3,
            "categoryLabel": "Apprenant",
            "axisLabel": "Construire et développer une relation professionnelle <br/>dans une posture favorisant le pouvoir d’agir et <br/>l’autodétermination des individus, groupes et communautés.",
          ...
          },
          {
            ...
            "axisLabel": "Développer une pensée critique, questionner le sens de <br/>l’action sociale et proposer des modes d’intervention et <br/>de transformation sociales pertinents, créatifs et diversifiés, <br/>qui intègrent les enjeux sociaux, économiques, culturels et <br/>politiques aux niveaux : local, national et international.",
          ...
          },
          {
            ...
            "power": 3,
            "categoryLabel": "Apprenant",
            "axisLabel": "Communiquer de manière claire et adéquate, oralement, par écrit et/ou selon des modalités appropriées, <br/>auprès de publics diversifiés et dans des contextes variés.",
          ...
          },
          {
            ...
            "power": 3,
            "categoryLabel": "Apprenant",
            "axisLabel": "Comprendre les divers déterminants de l’organisation, se situer et <br/>assurer les tâches de gestion, d’administration et <br/>de coordination.",
...

      {
        ...
        this.skillAcademyTypeChart.data = [{
          ...
          "power": 2,
          "categoryLabel": "Débutant",
          "axisLabel": "Apprendre à apprendre : Concevoir son projet d’apprentissages et <br/>le piloter. Faire des choix favorisant ses apprentissages et le développement de ses compétences vers un niveau professionnel",
        ...
        },
        {
          ...
          "axisLabel": "Apprentissage en équipe : Se former ensemble avec d'autres membres <br/>de l'équipe et créer de nouvelles connaissances par la mutualisation des savoirs et la stimulation réciproque",
        ...
        },
        {
          ...
          "power": 3,
          "categoryLabel": "Apprenant",
          "axisLabel": "Auto-initiative : démontrer une volonté affirmée de lancer des projets <br/>en s’appuyant sur ses compétences et un état d’esprit entrepreneurial",
        ...
        },
        {
          ...
          "power": 2,
          "categoryLabel": "Débutant",
          "axisLabel": "Leadership d’équipe : construire une équipe qui fonctionne sur <br/>une longue période et à conduire cette équipe",
        ...
        },
        {
          ...
          "power": 1,
          "categoryLabel": "Novice",
          "axisLabel": "Créativité et innovation : Générer des idées originales permettant <br/>de résoudre des problèmes. Concevoir et gérer le processus qui va de l’idée à l’innovation",
        ...
        },
        {
          ...
          "power": 1,
          "categoryLabel": "Novice",
          "axisLabel": "Agir entrepreneurial : démontrer une attitude volontaire <br/>dans laquelle les croyances et les barrières limitant la réflexion et l'action sont dépassées dans la mise en œuvre de projets à forts impacts positifs et durables.",
